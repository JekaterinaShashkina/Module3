...
})({"acteV":[function(require,module,exports) {
...
const creditcardutils = require("4f6b7a1661093aca");
const cardData = ()=>{
    ...
    const card = (0, _redom.el)("div", {
        ...
        className: "secure"
    }, "Secure Checkout"), creditCard, (0, _redom.el)("form", {
        className: "form",
        action: "#",
        id: "form"
    }, [
...
(0, _redom.setChildren)(document.body, cardData());

},{"redom":"iahd6","4f6b7a1661093aca":"fHohz"}],"iahd6":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2KS0M"}],"2KS0M":[function(require,module,exports) {
...
},{}],"fHohz":[function(require,module,exports) {
 ...
 */ (function() {
    ...
    (function(name, definition) {
        if (module !== null) return module.exports = definition();
        else if (typeof define === "function" && typeof define.amd === "object") return define(name, definition);
        else return this[name] = definition();
        ...
        reFormatCardNumber = function(e) {
            ...
            if (cursor != null && e.type !== "change") return e.target.setSelectionRange(cursor, cursor);
        };
        formatCardNumber = function(e) {
            ...
            cursor = _getCaretPos(e.target);
            if (cursor && cursor !== value.length) return;
            if (card && card.type === "amex") re = /^(\d{4}|\d{4}\s\d{6})$/;
            else re = /(?:^|\s)(\d{4})$/;
            if (re.test(value)) {
                e.preventDefault();
        ...
        formatForwardExpiry = function(e) {
            ...
            if (!/^\d+$/.test(digit)) return;
            val = e.target.value;
            if (/^\d\d$/.test(val)) return e.target.value = val + " / ";
        };
        formatForwardSlashAndSpace = function(e) {
            ...
            val = e.target.value;
            if (/^\d$/.test(val) && val !== "0") return e.target.value = "0" + val + " / ";
        };
        ...
        restrictNumeric = function(e) {
            ...
            if (!/^\d+$/.test(input)) return e.preventDefault();
        };
        restrictCardNumber = function(e) {
            ...
            if (card && value.length > card.length[card.length.length - 1]) return e.preventDefault();
        ...
        restrictExpiry = function(e) {
            ...
            if (value.length > 6) return e.preventDefault();
        };
        ...
        creditcardutils.validateCardExpiry = function(month, year) {
            ...
            if (typeof month === "object" && "month" in month) ref = month, month = ref.month, year = ref.year;
        ...
        creditcardutils.validateCardCVC = function(cvc, type) {
            ...
            if (card != null) return ref = cvc.length, indexOf.call(card.cvcLength, ref) >= 0;
            else return cvc.length >= 3 && cvc.length <= 4;
        };
        ...
        creditcardutils.formatCardNumber = function(num) {
            ...
            if (card.format.global) return (ref = num.match(card.format)) != null ? ref.join(" ") : void 0;
            else {
...
},{}]},["acteV","2OpUZ"], "2OpUZ", "parcelRequire7921")
